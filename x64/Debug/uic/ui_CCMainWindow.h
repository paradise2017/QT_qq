...
public:
    ...
    void setupUi(QWidget *CCMainWindowClass)
    {
        ...
        nameLabel->setMinimumSize(QSize(110, 22));
...
""));
        ...
        treeWidget->setMinimumSize(QSize(278, 474));
        treeWidget->setMaximumSize(QSize(280, 474));
        ...
        sizePolicy4.setHeightForWidth(bottomBtn_6->sizePolicy().hasHeightForWidth());
        bottomBtn_6->setSizePolicy(sizePolicy4);
        bottomBtn_6->setMinimumSize(QSize(24, 24));
        bottomBtn_6->setMaximumSize(QSize(86, 24));
    ...
    void retranslateUi(QWidget *CCMainWindowClass)
    {
        ...
        bottomBtn_6->setText(QCoreApplication::translate("CCMainWindowClass", "\345\272\224\347\224\250\345\256\235", nullptr));
    } // retranslateUi

...
public:
    ...
    void setupUi(QWidget *SkinWindow)
    {
        ...
        titlelcon = new QLabel(titleWidget);
        titlelcon->setObjectName(QString::fromUtf8("titlelcon"));
        QSizePolicy sizePolicy1(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(titlelcon->sizePolicy().hasHeightForWidth());
        titlelcon->setSizePolicy(sizePolicy1);
        titlelcon->setMinimumSize(QSize(42, 18));
        titlelcon->setMaximumSize(QSize(42, 18));

        horizontalLayout->addWidget(titlelcon);
